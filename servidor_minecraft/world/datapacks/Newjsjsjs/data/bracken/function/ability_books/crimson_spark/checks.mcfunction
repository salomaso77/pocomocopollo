...
execute if data storage bracken:config {ability_books_on:true} if entity @s[level=5..] run return run function bracken:ability_books/crimson_spark/crimson_spark
