...
execute if data storage bracken:config {ability_books_on:true} if entity @s[level=12..] run return run function bracken:ability_books/tetra_slime/tetra_slime
