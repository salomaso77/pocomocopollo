...
execute if data storage bracken:config {ability_books_on:true} if entity @s[level=2..] run return run function bracken:ability_books/fang_attack/fang_attack
