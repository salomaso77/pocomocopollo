...
execute at @a[distance=..30] run particle minecraft:dust{color:[1.0, 1.0, 0.0], scale:1.0} ~ ~1 ~ 0.2 0.4 0.2 0.01 1
particle minecraft:dust{color:[1.0, 1.0, 0.0], scale:1.0} ^1 ^16.5 ^.5 2 5 2 0 150
