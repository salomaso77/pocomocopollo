...
attribute @s minecraft:scale modifier add bracken:hunter.scale 2 add_multiplied_base

attribute @s minecraft:step_height modifier add bracken:hunter.step_height 1 add_value
